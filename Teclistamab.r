...
data_tecli <-read_excel('data/tecli_chemo_2025-07-04.xlsx', sheet = 2, skip = 1) %>%  select(Group, ISS_DX, SEX, CTX_S_DATE, BIRTH, CTX_LINE, HB_CTX, PLT_CTX, GFR_CTX, LDH_HIGH1_CTX, VS_PFS_CTX, DATE_PFS_CTX, PRE_CTX_R, VS, DATE_LAST, RESP_CTX, PID)%>% 
...
psm = matchit(Group~ CTX_LINE + AGE + PLT_CTX,
